...
public class LifestealAction extends AbstractGameAction {
    ...
    public LifestealAction(AbstractCreature target, DamageInfo info, AttackEffect attackEffect){
        this.info = info;
        ...
        if (this.shouldCancelAction()) {
            ...
            if (this.isDone) {
                ...
                if (this.target.lastDamageTaken > 0) {
                    //heal the player
                    AbstractDungeon.actionManager.addToBottom(new HealAction(this.source,this.source, this.target.lastDamageTaken));
